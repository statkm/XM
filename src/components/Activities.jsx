          ...
          <Box component="ol" sx={{ pl: 2 }}>
            <Box component="li" sx={{ mb: 2 }}>
              <Typography variant="body2">
                ...
                <Link href="https://ww3.aievolution.com/JSMAnnual2026/Events/viewEv?ev=6982" target="_blank" rel="noopener">
                  JSM2026
                </Link>.
              </Typography>
            </Box>
          ...
          <Box component="ol" sx={{ pl: 2 }}>
            <Box component="li" sx={{ mb: 2 }}>
              <Typography variant="body2">
                ...
                <Link href="https://pub.confit.atlas.jp/ja/event/jfssa2026/session/ermJRgfi" target="_blank" rel="noopener">
                  2026年度統計関連学会連合大会
                </Link>.
              </Typography>
            </Box>
            ...
            <Box component="li" sx={{ mb: 2 }}>
              <Typography variant="body2">
                ...
                <Link href="https://jscs.jp/conf-taikai40/" target="_blank" rel="noopener">
          ...
          <Box component="ol" sx={{ pl: 2 }}>
            <Box component="li" sx={{ mb: 2 }}>
              <Typography variant="body2">
                ...
                <Link href="https://www.link-j.org/event/article-52801.html" target="_blank" rel="noopener">
            ...
            <Box component="li" sx={{ mb: 2 }}>
              <Typography variant="body2">
                ...
                A Dichotomized Copula Approach for Multi-Arm Principal Stratification Without Monotonicity Assumption.{' '}
                <Link href="http://kdss.org/wp/wp-content/uploads/hpb-media/img/file1.pdf" target="_blank" rel="noopener">
